class Board {
   ...
   */
  init() {
    // Calcola la grandezza del canvas dalle costanti.
    this.ctx.canvas.width = COLS * BLOCK_SIZE;
    this.ctx.canvas.height = ROWS * BLOCK_SIZE;

    // Scala in automatico così da non dare una dimensione ad ogni
    // disegno.
   ...
   * @returns {Boolean} Vero se la posizione è valida, Falso se la posizione non è valida.
   * @memberof Board
   */
  insideWalls(x) {
    return x >= 0 && x < COLS;
